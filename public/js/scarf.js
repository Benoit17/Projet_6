...
//setup canvas
    var canvas = document.getElementById('scarf1');
...
//setup canvas
    var canvas = document.getElementById('scarf2');
    var ctx = canvas.getContext('2d');
    canvas.width = rows.length*(stsHeight-dip);
    canvas.height = caston*stsWidth;
...
//setup canvas
    var canvas = document.getElementById('scarf3');
    var ctx = canvas.getContext('2d');
    canvas.width = rows.length*(stsHeight-dip);
    canvas.height = caston*stsWidth;
...
//setup canvas
    var canvas = document.getElementById('scarf4');
    var ctx = canvas.getContext('2d');
    canvas.width = rows.length*(stsHeight-dip);
    canvas.height = caston*stsWidth;
...
//setup canvas
    var canvas = document.getElementById('scarf5');
    var ctx = canvas.getContext('2d');
    canvas.width = rows.length*(stsHeight-dip);
    canvas.height = caston*stsWidth;
